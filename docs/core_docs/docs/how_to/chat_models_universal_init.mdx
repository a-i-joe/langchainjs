...
Make sure you have the integration packages installed for any model providers you want to support. E.g. you should have `@aijoelangchain/openai` installed to init an OpenAI model.
:::
