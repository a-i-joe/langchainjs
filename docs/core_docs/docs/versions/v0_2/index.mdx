...
1. install the 0.2.x versions of `@aijoelangchain/core`, langchain and upgrade to recent versions of other packages that you may be using (e.g. `@langchain/langgraph`, `@langchain/community`, `@aijoelangchain/openai`, etc.)
...
| `@langchain/community` | `@aijoelangchain/openai`   | `import { ChatOpenAI } from "@langchain/community/chat_models/openai"`     | `import { ChatOpenAI } from "@aijoelangchain/openai"`                            |
| `langchain`            | `@aijoelangchain/core`     | `import { Document } from "langchain/schema/document"`                     | `import { Document } from "@aijoelangchain/core/documents"`                      |
...
Invoking the migration script will replace this import with `import ChatOpenAI from "@aijoelangchain/openai";`.
